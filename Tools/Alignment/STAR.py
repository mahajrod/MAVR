...
class STAR(Tool):
    ...
    def index(self, genome_dir, genome_fasta, annotation_gtf=None, junction_tab_file=None, sjdboverhang=None,
              genomeSAindexNbases=None, genomeChrBinNbits=None):
    ...
    def align(self, genome_dir, forward_read_list, reverse_read_list=None, annotation_gtf=None, junction_tab_file_list=None,
