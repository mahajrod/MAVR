...
parser.add_argument("-i", "--input", action="store", dest="input", required=True,
                    help="Input file with isoforms generated by toga")
...
parser.add_argument("-o", "--output", action="store", dest="output", required=True,
                    help="Output file with repaired isoforms.")

args = parser.parse_args()

isoforms = pd.read_csv(args.input, sep="\t", header=None, names=["gene", "transcript"])
...
isoforms.loc[isoforms["gene"].isna(),
             "gene"] = isoforms.loc[isoforms["gene"].isna(),
                                    "reference_transcript"].apply(lambda s: isoform_to_gene_dict[s] if s in isoform_to_gene_dict else pd.NA)
