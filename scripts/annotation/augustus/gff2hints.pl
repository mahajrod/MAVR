...
# modified to handle gff files other than produced by exonerate
# Sergei Kliver August, 2019
...
while (<XNT>) {
    s/#.*//;
    next unless /\S/;
    #next unless ((/\texonerate:cdna2genome\t/) || (/\texonerate:protein2genome:local\t/)); # modified by Sergei Kliver to handle exonerate output for cDNAs
