...
from Routines import FileRoutines, EggNOGRoutines
...
parser.add_argument("-d", "--hmmscan_output_dir", action="store", dest="hmmscan_output_dir",
                    default="hmmscan_output_dir/", type=FileRoutines.check_path,
...
parser.add_argument("--tblout_dir", action="store", dest="tblout_dir",
                    default="tblout_dir", type=FileRoutines.check_path,
...
parser.add_argument("--domtblout_dir", action="store", dest="domtblout_dir",
                    default="domtblout_dir", type=FileRoutines.check_path,
...
parser.add_argument("--pfamtblout_dir", action="store", dest="pfamtblout_dir",
                    default="pfamtblout_dir", type=FileRoutines.check_path,
...
ortholog_file = "%s.orthologs" % args.output_prefix
