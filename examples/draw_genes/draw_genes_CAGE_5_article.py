...
for sample in samples_dict:
    for region_index in [0, 1]:
        ...
        if region_index == 0:
            ...
            plt.text(-0.25, 0.5, description_dict[sample], rotation=90, fontweight="bold", transform=subplot.transAxes, fontsize=9,
                         horizontalalignment='center',
                         verticalalignment='center')
        ymax = max(samples_dict[sample][1])
...
for extension in ".jpg", ".svg", ".png":
    plt.savefig("CAGE_sbr_locus_TPM_article_different_scale%s" % extension)
