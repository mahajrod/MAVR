...
if __name__ == "__main__":
    ...
    for sample_set_name in sample_set_names_list:
        ...
        filtered_mutations.write(sample_set_name + "_SNP.vcf")
        filtered_out_mutations.write(sample_set_name + "_indel.vcf")


        filtered_mutations.get_location(annotations_dict, use_synonym=True, synonym_dict=annotation_synonym_dict)
