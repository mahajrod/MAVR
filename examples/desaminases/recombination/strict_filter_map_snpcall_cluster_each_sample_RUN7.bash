...
#SBATCH --error=/work/pavlov/okochenova/job_reports/RUN7/filtering_raw/job.%A_%a.err
#SBATCH --output=/work/pavlov/okochenova/job_reports/RUN7/filtering_raw/job.%A_%a.out 

module load compiler/gcc/4.8 fastx_toolkit/0.0.14 python/2.7 cutadapt/1.4 samtools/0.1 bowtie/2.2
...
/work/pavlov/okochenova/soft/rm_reads --adapters /work/pavlov/okochenova/kmers/service/illumina_testseq_trueseq_with_rc_23_mer.kmer -1 ${CURRENT_SAMPLE}_1.fastq -2 ${CURRENT_SAMPLE}_2.fastq -o ./filtered_raw
cd filtered_raw
/work/pavlov/okochenova/soft/MAVR/scripts/kmer/get_kmer_list.py -t 4  -m 23 -s 210000000 -a ${CURRENT_SAMPLE} -b -d -i ${CURRENT_SAMPLE}_1.ok.fastq,${CURRENT_SAMPLE}_2.ok.fastq,${CURRENT_SAMPLE}_1.se.fastq,${CURRENT_SAMPLE}_2.se.fastq
