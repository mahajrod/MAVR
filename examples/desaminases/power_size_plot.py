...
if __name__ == "__main__":
    ...
    homogeneity_dir = "power_size_plot/"
    ...
    for sample in sample_set_names_list:
        ...
        for suffix, name in zip(suffix_list, power_list):
            ...
            data[sample][name] = clusters.get_data_for_stat(additional_data=["Power"])
    ...
    for j in range(0, len(sample_set_names_list)):
        ...
        for i in range(0, len(power_list)):
            ...
            y_data = data[sample][name][:, 2] # Power
    ...
    plt.savefig("Power_size_3x4.svg")
    plt.savefig("Power_size_3x4.eps")
    plt.close()