...
if __name__ == "__main__":
    ...
    for sample_set in sample_set_names_list:
        ...
        variants, minus_variants = CollectionVCF(from_file=True, vcf_file=vcf_file).filter_by_expression("(record.ref == 'C' and record.info_dict['Fstrand'][0] == 'M') or (record.ref == 'G' and record.info_dict['Fstrand'][0] == 'P')") # nontranscribed thread
