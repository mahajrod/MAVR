...
target_seq = CollectionSequence(
    in_file="/home/skliver/bff_spematogenesis/homo_sapiens.repeatmasker.trf.windowmasker.fasta")
query_seq = CollectionSequence(
    in_file="/home/skliver/bff_spematogenesis/mustela_nigripes.v2.smithsonian.repeatmasker.trf.windowmasker.fasta")

gff_coll = CollectionGFF(in_file="/home/skliver/sp_spermatogenesis/homo_sapiens.gff",
                         format="gff", parsing_mode="complete",
                         featuretype_separation=True,
                         scaffold_syn_dict=None)

last_coll = CollectionLast(in_file="/home/skliver/bff_spematogenesis/mustela_nigripes.to.homo_sapiens.R11.tab.gz",
...
output_dir = "/home/skliver/bff_spematogenesis/all"
