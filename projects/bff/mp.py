...
target_seq = CollectionSequence(
    in_file="/home/skliver/mp_spermatogenesis/homo_sapiens.repeatmasker.trf.windowmasker.fasta")
query_seq = CollectionSequence(
    in_file="/home/skliver/mp_spermatogenesis/mustela_putoris.v1.earlham.repeatmasker.trf.windowmasker.fasta")

gff_coll = CollectionGFF(in_file="/home/skliver/mp_spermatogenesis/homo_sapiens.gff",
                         format="gff", parsing_mode="complete",
                         featuretype_separation=True,
                         scaffold_syn_dict=None)

last_coll = CollectionLast(in_file="/home/skliver/mp_spermatogenesis/mustela_putorius.to.homo_sapiens.R11.tab.gz",
                           parsing_mode="complete")
output_dir = "/home/skliver/mp_spermatogenesis/all/"
