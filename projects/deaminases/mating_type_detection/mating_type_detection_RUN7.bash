...
LEFT_READS_FILE=${READS_DIR}${CURRENT_SAMPLE}"N085-LAN210-Can-PmCDA1-NA-RUN7-D1_1.ok_val_1.fq"
RIGHT_READS_FILE=${READS_DIR}${CURRENT_SAMPLE}"N085-LAN210-Can-PmCDA1-NA-RUN7-D1_2.ok_val_2.fq"
