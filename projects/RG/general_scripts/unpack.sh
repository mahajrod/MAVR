...
for SAMPLE in ${SAMPLE_LIST[@]};
    ...
    mkdir -p ${UNPACKED_READS_DIR} ${UNPACKED_READS_DIR}/${SAMPLE};
    FILES=($(ls ${RAW_READS_DIR}/${SAMPLE}/*.f*q.gz | sed 's/.gz//'));
    ...
    LEFT_UNPACKED_FILE=${UNPACKED_READS_DIR}/${SAMPLE}/${SAMPLE}_1.fastq
    RIGHT_UNPACKED_FILE=${UNPACKED_READS_DIR}/${SAMPLE}/${SAMPLE}_2.fastq
