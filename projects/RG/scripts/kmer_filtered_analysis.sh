...
for SAMPLE in ${SAMPLE_LIST[@]};
    ...
    SAMPLE_JF_DIR=${JF_DB_FILTERED_DIR}/${SAMPLE_GROUP}/${SAMPLE}/
    SAMPLE_KMER_STAT_DIR=${KMER_STAT_FILTERED_DIR}/${SAMPLE_GROUP}/${SAMPLE}/

    mkdir -p ${KMER_STAT_FILTERED_DIR}/${SAMPLE_GROUP} ${SAMPLE_KMER_STAT_DIR};
    mkdir -p ${JF_DB_FILTERED_DIR}/${SAMPLE_GROUP} ${SAMPLE_JF_DIR};
    #get comma-separated list of files in ${FILTERED_READS_DIR}/${SAMPLE_GROUP}/${SAMPLE}
    FILES_COMMA=`ls -m ${FILTERED_READS_DIR}/${SAMPLE_GROUP}/${SAMPLE}/* | sed -r "s/, /,/g" | tr -d '\n'`;
